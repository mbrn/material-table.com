      ...
      <div className={this.props.classes.root}>
        <div className={this.props.classes.topBar}>
          <div className={this.props.classes.topBarContent}>
            <Typography variant="h1" className="text" style={{color: 'white'}}>{this.props.config.title}</Typography>
            <Typography variant="h6" className="text" style={{color: 'white'}}>{this.props.config.subTitle}</Typography>
